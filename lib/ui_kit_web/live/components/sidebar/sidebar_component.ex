defmodule UiKitWeb.SidebarComponent do
    ...
    <div class="mx-auto py-10">
      <aside class="w-64">
        <div class="px-3 py-4 overflow-y-auto rounded">
          <h1 class="text-2xl font-bold mb-10 cursor-pointer text-indigo-600 duration-150">
            Gongo UI KIT
          </h1>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <button
                ...
                @click="dropdown_component = !dropdown_component"
              >
                <svg
                  class="flex-shrink-0 w-6 h-6 text-indigo-800 transition duration-75"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                ...
                <svg
                  class="w-6 h-6"
                  :class="{'rotate-180': dropdown_component, 'rotate-0': !dropdown_component}"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              >
                <li>
                  <%= live_patch("Button",
                    to: Routes.buttons_path(@socket, :buttons),
                    class:
                ...
                <li>
                  <%= live_patch("Modal",
                    to: Routes.modals_path(@socket, :modals),
                    class:
                      "flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 pl-11"
                  ) %>
                </li>
